...
internal static class DatabaseObjectExtensions
{
    ...
    internal static T? GetObject<T>(this ObjectId id, bool forWrite = false) where T : DBObject
    {
    ...
    internal static IEnumerable<T> GetObjects<T>(this SymbolTable table, bool forWrite = false) where T : DBObject =>
    ...
    internal static IEnumerable<T> GetObjects<T>(this BlockTableRecord block, bool forWrite = false) where T : Entity =>
