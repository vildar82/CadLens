// ReSharper disable once CheckNamespace -- Matches the native type in the linked contract.
namespace Autodesk.AutoCAD.DatabaseServices;

// Only needed to compile the highlight interface linked into managed composition tests.
