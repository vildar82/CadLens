...
- Emphasize the chosen layer's objects and dim the rest temporarily. Choosing a primitive type narrows emphasis within that layer; choosing an individual object updates its highlight and preview.
