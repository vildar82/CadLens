...
- [x] 1.3 Gate drawing actions on lens activity and reject canceled results; verify deactivation remains available during pending work and controlled late read/emphasis completions cannot reactivate the lens, publish stale content, or restore effects.
...
- [x] 5.3 Preserve cancellation, cleanup ordering, failure/retry, close, and context guards when switching arbitrary modules; let Layers own explicit refresh and context reloads.
