...
Сейчас есть Git-репозиторий, пустое решение `CadLens.slnx` и описание идеи. Для первого AutoCAD-плагина создана только папка изменения OpenSpec с метаданными; документов планирования, проектов C#, кода и проверки в AutoCAD пока нет.